        ...
        {screens.map((screen: any) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <Link to={`/screen/${screen.slug}`} ><button className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition font-medium mt-5 w-full">Show Details</button></Link>
            </div>
          </div>
        ))}
      </div>
